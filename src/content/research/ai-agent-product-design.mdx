...
englishTitle: 'From Answers to Actions: Interaction, Workflow and Control in AI Agent Products'
heroLabel: 'AI 产品研究'
subtitle: 'AI Agent 产品的交互、工作流与控制权设计'
heroSummary: 'AI Agent 的价值不只是“比 Chatbot 多调用几个工具”，而是让 AI 开始围绕用户目标持续规划、执行、观察和调整。当 AI 开始真正影响外部世界，产品设计的重点也从“回答得好不好”转向“什么时候应该行动、行动到什么程度，以及用户如何重新获得控制权”。'
type: 'AI 产品研究'
section: 'research'
...
pageCount: 29
tocDepth: 2
description: '当 AI 从“回答问题”进一步走向“完成任务”，产品设计的核心问题也从生成质量扩展到了任务理解、规划执行、控制权、异常恢复与结果验证。本文从 AI 产品经理视角，系统拆解 Chatbot、Workflow 与 Agent 的边界，并围绕自主性、Human-in-the-loop、状态管理、信任设计和 Agent 评测建立一套完整的产品分析框架。'
tags: ['AI Agent', 'AI 产品', 'Human-in-the-loop', 'Agent UX', '产品设计']
featured: true
homepageFeatured: true
homepageOrder: 1
cover: '../../assets/report-covers/ai-agent-product-research.webp'
coverAlt: '《从“回答问题”到“完成任务”》AI Agent 产品研究报告封面，白色版面展示中文标题、研究核心问题与 2026.08 版本信息'
pdfUrl: '/reports/ai-agent-product-research.pdf'
